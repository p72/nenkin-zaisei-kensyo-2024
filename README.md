...
| 拠出金按分据置型（按分は現行のまま） | 57.94%（基礎は調整不要、上の天井） | 21.73% | 36.21% |
...
- 拠出金按分据置型の +7.55pt の大半は、壁が逆向きに振れた効果です。上がった基礎年金の
  費用は大半を厚生年金（報酬比例 −3.15pt）と**国庫（2100年度に年7兆円増）**が払い、
  3号の保険料の6割（過去30年投影）は給付に使われず国民年金の積立金に積み上がります
  （2119年度に積立度合53年分）。高所得の単身・共働きは損をしうるので、「全員が得をする」
  とは言えません
