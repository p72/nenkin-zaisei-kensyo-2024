...
`検証/掲載表/README.md`、`検証/数式編/README.md`、`検証/図/README.md`）。
...
時系列は照合していません。各表の「2024年度価格」列は、換算率の系列が
こちらの比例改定率そのものだと確定しましたが（2026年度以降は最大相対差
`6.0e-15`）、2024年度の1要素だけ出所が特定できていません（§15.0.2）。
