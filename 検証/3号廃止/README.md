...
| **拠出金按分据置型（国年充当）** | 第3号から保険料を徴収するが、3号分の基礎年金費用は引き続き被用者年金が負担する | `SANGO_MODE=1` |
| **厚年留保案** | 第3号から保険料を徴収して**厚生年金勘定**に入れ、按分も据え置く。浮いた分で厚生年金保険料率を下げる（大和総研レポートの照合、[厚年留保案.md](厚年留保案.md)） | `RYUHO`・`RYUHO_RITU` |
...
| 過去30年投影 | 拠出金按分据置型（国年充当） | **57.94%** | 21.73% | 36.21% | **2024年度（調整不要、上の天井）** | **54.49** |
| 過去30年投影 | 現行＋調整期間の一致 | **56.16%** | 22.92% | 33.24% | 2036年度 | —（一体で均衡） |
| 過去30年投影 | 第1号移行型＋一致 | **57.52%** | 23.48% | 34.04% | 2033年度 | —（一体で均衡） |
| 過去30年投影 | 拠出金按分据置型（国年充当）＋一致 | **57.52%** | 23.48% | 34.04% | 2033年度 | —（一体で均衡） |
| 高成長実現 | 現行制度 | **56.91%** | 24.97% | 31.94% | 2039年度 | 1.00 |
| 高成長実現 | 第1号移行型 | **49.53%** | 24.97% | 24.55% | 2058年度 | 1.00 |
| 高成長実現 | 拠出金按分据置型（国年充当） | **61.18%** | 24.97% | 36.21% | 2024年度（上の天井） | **62.57** |
| 高成長実現 | 現行＋一致／第1号移行型＋一致／按分据置型（国年充当）＋一致 | **61.18%** | 24.97% | 36.21% | 2024年度（調整不要） | —（一体で均衡） |
...
| 拠出金按分据置型（国年充当） | 57.94% | +0.42pt | 上の天井に当たったことによる歪み |
...
| **拠出金按分据置型（国年充当）** | **57.94%** | 21.73% | **36.21%** | 2040年度 | **2024年度（調整不要）** |

| 高成長実現ケース | 所得代替率 | うち比例 | うち基礎 |
|---|---|---|---|
| 現行制度 | 56.91% | 24.97% | 31.94% |
| 第1号移行型 | 49.53% | 24.97% | 24.55% |
| **拠出金按分据置型（国年充当）** | **61.18%** | 24.97% | **36.21%** |
...
| 過去30年投影 | 拠出金按分据置型（国年充当） | 36.21% | 205.4 | 102.7（+24%） | 0.50 |
| 高成長実現 | 現行＋一致／3号廃止＋一致／按分据置型（国年充当） | 36.21% | 107.2 | 53.6（+11%） | 0.50 |
...
### 按分据置型（国年充当）に適用拡大を重ねたら — 天井の上では上乗せがない

適用拡大（約860万人、厚生労働省のオプション試算）を行ったうえで、残った第3号に
按分据置型で保険料を求めた。第1号・第3号のどちらから何人が被用者になるかは、
①被保険者推計の適用拡大の前提（`KAKUDAI=4`）がそのまま決める。20〜59歳・年度末で
見ると、2027年度に第2号が627万人増え、うち第1号から359万人、第3号から267万人である
（過去30年投影）。保険料を求める第3号は、現行の606万人ではなく339万人になる。

| 所得代替率（調整終了後） | 現行制度 | 適用拡大 | 按分据置型（国年充当） | 按分据置型＋適用拡大 |
|---|---|---|---|---|
| 過去30年投影 | 50.4% | 56.3%（比例 23.1 / 基礎 33.2） | 57.9%（21.7 / 36.2） | **57.8%**（21.6 / 36.2） |
| 高成長実現 | 56.9% | 61.2%（天井） | 61.2%（天井） | **61.2%**（天井） |

- **按分据置型だけで基礎年金は天井（「調整なし」）に当たっているので、適用拡大を重ねても
  基礎年金は上がらない。** 差は報酬比例（21.7 → 21.6%、調整終了 2040 → 2043年度）と
  積立金に出るだけ
- 国民年金の積立金は、保険料を払う第3号が減るぶん小さくなる（2120年度 394 → 268兆円、名目）
- どちらも国民年金勘定を軽くする手段なので、片方で天井に当たると、もう片方はほとんど効かない

④⑤だけを外枠 3403 で流し直した適用拡大は、①から流した適用拡大と出力がラベル以外ビット一致する
（⑤にも `KAKUDAI=4` を渡す）。この組み合わせはそれに `SANGO=2027 SANGO_MODE=1` を足しただけである。

現行制度との対照表（[過去30年投影](図/対照表_3003_541_按分据置と適用拡大.pdf)・
[高成長実現](図/対照表_3001_541_按分据置と適用拡大.pdf)）、
按分据置型との対照表（[過去30年投影](図/対照表_3003_501-541_按分据置対按分据置と適用拡大.pdf)・
[高成長実現](図/対照表_3001_501-541_按分据置対按分据置と適用拡大.pdf)）

![財政見通し対照表：過去30年投影ケース・按分据置型 対 按分据置型＋適用拡大](図/対照表_3003_501-541_按分据置対按分据置と適用拡大.png)
...
| 図 | 内容 |
|---|---|
| `所得代替率_按分据置.png` | **§4.7 用**。現行制度と拠出金按分据置型（国年充当）の2本、2ケース × 3内訳。注釈つき |
...
| `対照表_3003_501_按分据置.png` `対照表_3001_501_按分据置.png`（と `.pdf`） | **財政見通し対照表**。厚生労働省の「財政見通し」と同じ形で、厚生年金・国民年金を現行制度と按分据置型（国年充当）の2行ずつ並べた1枚（A4縦）。現行と違う値は太字。`make_taishohyo.py` |
...
検証/3号廃止/run_sango.sh 2027 0.8                 # 16本（ビルド1回＋各2分弱）
...
WAKU=3403 KAKUDAI=4 YOBI=040 検証/実行/run_pipeline.sh 3003 1 1 0 2                 # 適用拡大（①から。541 の前提）
STEPS=45 WAKU=3403 KAKUDAI=4 YOBI=541 SANGO=2027 SANGO_MODE=1 検証/実行/run_pipeline.sh 3003 1 1 0 2  # 按分据置型＋適用拡大
```
