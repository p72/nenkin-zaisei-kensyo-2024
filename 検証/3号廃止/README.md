...
按分据置型は「追加の財源なしで給付が上がる」設計ではない（§4.7）。
...
余り、残りは運用収入とともに積立金に積み上がる。

![国民年金勘定の年度末積立金](図/国年積立金_按分据置.png)

| 2024年度価格 | 過去30年投影 | 高成長実現 |
|---|---|---|
| 3号の保険料の累計（2027〜2119年度） | 60兆円 | 53兆円 |
| うち国民年金勘定が給付に使った分 | **42%** | **17%** |
| 国民年金の年度末積立金（2119年度） | 現行 1.5兆円 → **114兆円** | 現行 1.5兆円 → **107兆円** |
| 積立度合（2119年度） | 現行 1.1年分 → **53年分** | 現行 1.1年分 → **61年分** |

「給付に使った分」は、国民年金勘定の実負担（基礎年金拠出金 − 国庫負担）の増を
保険料の増で割ったもの（どちらも2024年度価格で累計）。有限均衡方式は2120年度に
積立度合1を目標にするので、53〜61年分は目標から大きく外れている。
現実の制度なら、この余剰は保険料の引き下げか勘定間の移転で使われるはずで、
**余剰の行き先の設計が次の論点になる**。
...
| `国年積立金_按分据置.png` | **§4.7 用**。国民年金勘定の年度末積立金（2024年度価格）と積立度合。`make_tumitate_chart.py` |
...
0. **按分据置型で積み上がる国民年金の余剰の行き先を設計する。** 積立度合が
   53〜61年分になるのは、保険料を取りながら使い道がないためである。第1号の保険料を
   引き下げる、厚生年金勘定へ移転する、などの案で結果がどう変わるかを見る
   （`hoken17000.csv` を差し替えるレバーが要る。下の3と同じ）
