...
SCENARIOS = {
    "501": dict(
        ...
        title="第3号被保険者に保険料を課し基礎年金拠出金の按分は据え置いた場合（拠出金按分据置型・国年充当）",
        desc="按分据置型（国年充当）：2027年度から第3号（20〜59歳）が第1号と同じ定額保険料を全員納付。"
    ...
    "501-040": dict(
        ...
        desc="按分据置型（国年充当、上の行）：2027年度から第3号（20〜59歳）が第1号と同じ定額保険料を全員納付。"
    ...
    "541": dict(
        ...
        waku={"3003": "3403", "3001": "3401"},
        title="被用者保険の適用拡大（約860万人）と拠出金按分据置型（国年充当）を組み合わせた場合",
        desc="按分据置（国年充当）＋適用拡大：適用拡大（約860万人、厚生労働省のオプション試算）を行ったうえで、"
    ...
    "501-541": dict(
        ...
        base=("501", "501", "按分据置型"), waku={"3003": "3403", "3001": "3401"},
        title="拠出金按分据置型（国年充当）に被用者保険の適用拡大（約860万人）を重ねた場合",
        desc="按分据置型（国年充当、上の行）：2027年度から第3号（20〜59歳）が第1号と同じ定額保険料を全員納付。"
             "基礎年金拠出金の按分（頭数）は現行のまま<br>"
...
CASES = {"3003": "過去30年投影ケース", "3001": "高成長実現ケース", "3002": "成長型経済移行・継続ケース"}
